...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG.rdoc", "README.md", "lib/custom_error_handler.rb"]
  s.files = ["CHANGELOG.rdoc", "Gemfile", "MIT-LICENSE", "README.md", "Rakefile", "app/controllers/custom_errors_handler_controller.rb", "init.rb", "lib/custom_error_handler.rb", "Manifest", "custom_errors_handler.gemspec"]
